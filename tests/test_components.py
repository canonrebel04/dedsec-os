...
class TestButton(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.button = Button(name="TestButton", rect=self.rect, on_click=self.callback)
...
class TestModal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.modal = Modal(title="Test Modal", rect=self.rect)
...
class TestTextDisplay(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.text_display = TextDisplay(name="TestDisplay", rect=self.rect)
